...
class ContentContainer {
  ...
  removeElement(element) {
    ...
    // можна через фільтр
    // const value_delete = this.elements[this.elements.indexOf(element)];
    // this.elements.filter((value) => value !== value_delete);
  }
}
...
class Message extends ContentContainer {
  ...
  display() {
    console.log(`Повідомлення: ${this.content}`); // добавив, щоб виглядало як в домашці
